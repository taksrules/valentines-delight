...
export default function Button({
  ...
  const variantStyles = {
    ...
    outline: 'bg-transparent border-2 border-rose-500 text-rose-500 hover:bg-rose-50 focus:ring-rose-500 dark:border-rose-400 dark:text-rose-400 dark:hover:bg-rose-400/5'
  };
