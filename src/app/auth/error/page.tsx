...
export default function AuthErrorPage() {
  return (
    <Container className="flex items-center justify-center min-h-[70vh]">
      <Suspense fallback={
        <div className="max-w-md w-full bg-white dark:bg-neutral-900 p-8 rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-xl text-center animate-pulse">
          <div className="w-16 h-16 bg-neutral-100 dark:bg-neutral-800 rounded-full mx-auto mb-6"></div>
          <div className="h-8 bg-neutral-100 dark:bg-neutral-800 rounded w-3/4 mx-auto mb-4"></div>
          <div className="h-4 bg-neutral-100 dark:bg-neutral-800 rounded w-1/2 mx-auto mb-8"></div>
          <div className="h-24 bg-neutral-100 dark:bg-neutral-800 rounded-2xl mb-8"></div>
          <div className="space-y-4">
            <div className="h-12 bg-neutral-100 dark:bg-neutral-800 rounded-xl w-full"></div>
            <div className="h-12 bg-neutral-100 dark:bg-neutral-800 rounded-xl w-full"></div>
          </div>
        </div>
      }>
